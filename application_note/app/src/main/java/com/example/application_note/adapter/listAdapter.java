...
public class listAdapter extends RecyclerView.Adapter
{
    ...
    public listAdapter(Context context, List<Note>note, AppCompatActivity ac){
    ...
    private static class ItemHolder extends RecyclerView.ViewHolder{
        ...
        private ItemHolder(View view){
           ...
           // description=(TextView)view.findViewById(R.id.description);
            ...
            color=(ImageView)view.findViewById(R.id.color_image1);
            favoris=(ImageView)view.findViewById(R.id.fav_image1);
            delete=(Button)view.findViewById(R.id.btn_delete1);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View items= LayoutInflater.from(parent.getContext()).inflate(R.layout.layout,parent,false);
